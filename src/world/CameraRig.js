...
export default class CameraRig {
  ...
  update(scroll, time, intro = 1) {
    ...
    // look toward the column centre, curving down toward the black hole as
    // the descent approaches its end (the destination comes into view)
    this._look.set(
      this.mouse.x * 1.4,
      y - 6 - scroll * scroll * 46 - this.mouse.y * 1.0,
      0
    );
    if (intro < 1) {
